					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								...
								<h4 class="blue" id="id-company-text">&copy; Laboratoire National de Controle des Medicaments</h4>
							</div>
									...
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header blue lighter bigger">
												...
												Entrez vos informations s'il vous plait
											</h4>
												...
												<fieldset>
													...
													<div class="clearfix">
														<label class="inline">
															...
															<span class="lbl">Rester connecté</span>
														</label>
