        ...
        <div class="widget-content nopadding">
          <form action="{{ route('reactifs.update', [$reactif->id])}}" method="post" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input id="datetime" type="datetime-local" class="span11 form-control" required placeholder="Date de Reception" name="created_at" spellcheck="false" value="{{ $reactif->created_at}}"  />
              </div>
            </div>
