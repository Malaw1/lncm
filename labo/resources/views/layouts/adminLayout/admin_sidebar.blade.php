...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li> <a href="{{('/admin/reactifs')}}"><i class="icon icon-signal"></i> <span><strong>Echantillons</strong> </span></a> </li>
    ...
    <li><a href="{{('/admin/stocks')}}"><i class="icon icon-fullscreen"></i> <span><strong>Stock</strong> </span></a></li>
